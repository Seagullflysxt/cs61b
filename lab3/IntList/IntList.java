...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        if (A == null && B != null) {
            ...
            ptr = ptr.rest;
            ptr.rest = new IntList(B.first, null);*/
        return new IntList(A.first, catenate(A.rest, B));    //NOTICE:Recursive
    }
    ...
    public static IntList reverse(IntList A) {
        ...
        while(A.rest != null){
            A = A.rest;
            ptr = new IntList(A.first,ptr);
        }
        return ptr;*/

       //destructive version 2
        IntList restOfList = A.rest;
        A.rest = null;
        while (restOfList != null) {
            A = new IntList(restOfList.first, A);
